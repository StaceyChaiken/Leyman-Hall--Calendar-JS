...
// Definition of the function that generatees the calendar table
...
// Definition of the function to write calendar caption
function calCaption(calDate) {
   // monthName contains the list of month names
   let monthName = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];

   // Determine the numeric value of the current month
   let thisMonth = calDate.getMonth();
   // Detemine the current year of the date give
...
// Definition of a function to write a table row weekday abbreviations
...
function daysInMonth(calDate) {
   ...
   let dayCount = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30];
...
// Definition of the function to write the table rows each day in the month
function calDays(calDate) {
   ...
   // Write blank cells preceedig the starting day
   let htmlCode = "<tr>";
